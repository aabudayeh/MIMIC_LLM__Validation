...
DOWNLOAD_DIRECTORY_MIMICIV = "../2-explainable-medical-coding/data/raw/physionet.org/files/mimiciv/2.2"  # Path to the MIMIC-IV data. Example: ~/physionet.org/files/mimiciv/2.2
DOWNLOAD_DIRECTORY_MIMICIV_NOTE = "../2-explainable-medical-coding/data/raw/physionet.org/files/mimic-iv-note/2.2"  # Path to the MIMIC-IV-Note data. Example: ~/physionet.org/files/mimic-iv-note/2.2
